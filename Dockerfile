...
RUN apt-get update  -y && apt-get upgrade -y &&  \
    ...
    apt-get install -y wget curl unzip bzip2 git ctags htop supervisor xclip silversearcher-ag && \ 
...
## r-essentials
RUN conda install -c http://mirrors.ustc.edu.cn/anaconda/pkgs/r r-essentials -y && \
    conda clean -a -y
## neovim， 代替vim
